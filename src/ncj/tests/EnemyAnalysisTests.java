...
public class EnemyAnalysisTests {
	...
	FiringSolution _solution = new FiringSolution().setEnemyPoint(new Vector2D(0,0)).setPointToFireFrom(new Vector2D(0, 0)).setWaveVector(new Vector2D(1, 1)).setPointEnemyBulletHits(new Vector2D(2, 3));
